...
{% details Formalizing capabilities with the (t,n)-AGI framework %}
...
{% details What are the historical empirical evidences for the Bitter Lesson? %}
...
{% details What are the scaling equations? %}
...
{% details 2022 Chichilla's scaling law %}
...
{% details Why forecasting AI is so important? %}
...
* First, assess _how much computation the human brain performs_, translating this into a quantifiable measure similar to computer operations in FLOP/s.
* Second, estimate _the amount of computation needed to train a neural network to match the brain's inferential capacity_, adjusting for future improvements in algorithmic efficiency.
* Third, examine _when it would be feasible to afford such computational resources_, taking into account the decreasing cost of compute, economic growth, and increasing investment in AI.
...
{% details Neural network Anchors %}
...
{% details Affordability of compute %}
...
{% details Takeoff Speeds vs Continuity %}
...
{% details Homogenous vs Heterogeneous takeoff %}
...
{% details Are the LLM not creative? %}
...
{% details Is it true that all deep learning models require massive amounts of data? %}
...
{% details Is it true that LLMs are intrisically non-robusts? %}
...
{% details The Stochastic Parrot hypothesis: Do AIs only memorize information without truly compressing it? %}
...
{% details Will LLMs Inevitably Hallucinate? %}
...
{% details Missing Long-Term Memory in AI? %}
...
{% details Missing Planning Capabilities? %}
...
{% details What are some similarities between LLMs and the linguistic cortex? %}
...
{% details What are some reasons to believe that labs will continue to scale LLMs? %}
